...
> [!IMPORTANT]
> The audit acknowledges that some protections (Signer checks, Cosigner limits) are active. However, as long as **VUL-01** and **VUL-02** exist, the system cannot be considered secure.
